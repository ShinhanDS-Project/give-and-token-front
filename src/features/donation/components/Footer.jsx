...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t-8 border-line bg-[#FFF9F5] pt-20 pb-10">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 grid gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            <h4 className="mb-8 text-2xl font-display font-bold text-ink">나눔 서비스</h4>
            <ul className="space-y-5 text-[0.9rem] font-bold text-stone-500">
              <li>
          ...
          <div className="lg:col-span-5">
            <div className="relative overflow-hidden rounded-[2rem] border-4 border-line bg-white p-6 shadow-sm">
              <div className="absolute right-0 top-0 h-32 w-32 -mr-16 -mt-16 rounded-full bg-accent/10 blur-xl" />
              <h4 className="relative mb-4 text-[1.7rem] font-display font-bold text-ink">
                기부단체 가입 신청하기
              </h4>
              <p className="relative mb-6 text-[0.9rem] font-medium text-stone-500">
              ...
              <div className="flex justify-end -mt-1">
                <Link
                  ...
                  className="relative inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-all hover:-translate-y-1 hover:bg-primary/90 active:translate-y-0 whitespace-nowrap"
                >
                  기부단체 신청 페이지로 가기
                  <ArrowRight size={16} />
                </Link>
        ...
        <div className="flex flex-col items-center justify-between gap-8 border-t-4 border-line pt-10 text-xs font-bold uppercase tracking-widest text-stone-400 md:flex-row">
